...
# Design: Structural Booth-Wallace Multiplier (No Zero Detection)
#
# Usage:
#   openroad -no_init -exit scripts/power_vcd.tcl
#   Run from project root: structural-baseline/
#
# Prerequisites:
...
puts "\n=== Power Report — Structural Baseline (VCD 70% zero, 16ns clock) ==="
